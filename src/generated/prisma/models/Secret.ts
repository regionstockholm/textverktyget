...
export type SecretWhereInput = {
  ...
  cipherText?: Prisma.StringFilter<"Secret"> | string
  createdAt?: Prisma.DateTimeFilter<"Secret"> | Date | string
  updatedAt?: Prisma.DateTimeFilter<"Secret"> | Date | string
  updatedBy?: Prisma.StringNullableFilter<"Secret"> | string | null
}
...
export type SecretScalarWhereWithAggregatesInput = {
  ...
  cipherText?: Prisma.StringWithAggregatesFilter<"Secret"> | string
  ...
  updatedBy?: Prisma.StringNullableWithAggregatesFilter<"Secret"> | string | null
}
...
export type SecretOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "cipherText" | "createdAt" | "updatedAt" | "updatedBy", ExtArgs["result"]["secret"]>
...
export interface SecretDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const secretWithNameOnly = await prisma.secret.findMany({ select: { name: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Secrets and only return the `name`
   * const secretWithNameOnly = await prisma.secret.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Secrets and only return the `name`
   * const secretWithNameOnly = await prisma.secret.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
